@extends('layouts.app')
@section('title','Halaman Laporan Kasir Detail')
@section('subtitle','Menu Laporan Kasir Detail')
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($p->status_bayar === 'Sudah Lunas')
                            <span class="badge badge-success">{{ $p->status_bayar }}</span>
                        @else
                            <span class="badge badge-danger">{{ $p->status_bayar }}</span>
                        @endif
                    </td>
                    <td>
                        @if($p->status_batal !== null)
                            <span class="badge badge-danger">{{ $p->status_batal }}</span>
                        @else
                            <span class="badge badge-info">Tidak ada pembatalan</span>
                        @endif
                    </td>
