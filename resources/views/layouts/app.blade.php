...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('template/dist/img/logo_gce.png') }}">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('template') }}/dist/img/logo_gce.png" alt="Logo GCE"
                ...
                <li class="nav-item">
                    ...
                    <b class="nav-link" role="button">
                        <span class="badge bg-primary">
                            Cabang : {{ $namaCabang ? $namaCabang : 'SEMUA CABANG' }}
                        </span>
                    </b>
                </li>
    ...
    <script>
        ...
        // Get the element with ID "currentYear"
