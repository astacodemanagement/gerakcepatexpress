@extends('layouts.app')
@section('title', 'Halaman Belum Ambil')
@section('subtitle', 'Menu Belum Ambil')
...
@section('content')
                        ...
                        <tr>
                            ...
                            @elseif($p->status_batal === 'Verifikasi Disetujui')
                                <td>
                                    ...
                                    <br>
                                    <span class="float-left badge bg-warning" style="font-size: larger;">Kode:
                                        {{ $p->kode_pembatalan }}</span>
                            ...
                            @elseif($p->status_batal === 'Verifikasi Ditolak')
                                <td>
                                    <span class="float-left badge bg-danger"
                                        style="font-size: 14px;">{{ $p->status_batal }}</span>
                                    <br>
                                    <span class="float-left badge bg-danger" style="font-size: 10;">Alasan:
                                        {{ $p->alasan_tolak }}</span>
                                </td>
                            @else
                            ...
                            <td>
                                ...
                                <a style="color: rgb(242, 236, 236)" href="#"
                                    class="btn btn-sm btn-primary btn-detail" data-toggle="modal"
                                    data-target="#modal-cetak-resi" data-id="{{ $p->id }}"
    ...
    <div class="modal fade" id="modal-cetak-resi" tabindex="-1" role="dialog" aria-labelledby="modal-cetak-resi-label"
        aria-hidden="true">
...
@push('script')
    <script>
        ...
        $(document).on('click', '.btn-detail', function() {
            ...
            $(`<iframe src="${baseUrl}/resi/${resiId}/detail/belum-diambil" class="iframe-resi" frameborder="0" style="width:100%;height:100%"></iframe>`)
        ...
        $('.btn-cetak-resi').on('click', function() {
            ...
            $('.print-element').html(
                `<iframe src="${baseUrl}/resi/${resiId}/detail/belum-diambil?print=true" class="iframe-resi" frameborder="0" style="width:100%;height:100%"></iframe>`
                );
        })
